// Package auth реализует аутентификацию пользователей на основе JWT-токенов.
// Предоставляет middleware для HTTP-обработчиков и функции для создания/проверки токенов.
package auth
